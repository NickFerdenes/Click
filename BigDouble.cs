        ...
        private static class BigNumber
        {
            public static string FormatBigDouble(BigDouble value, string format, IFormatProvider formatProvider)
            {
                ...
                switch (formatSpecifier)
                {
                    ...
                    case 'M':
                        return MyFormat(value, formatDigits);
                }
            ...
            //Мой метод
            private static string MyFormat(BigDouble value, int places)
            {                
                if (value.Exponent <= -ExpLimit || IsZero(value.Mantissa))
                {
                    return "0" + (places > 0 ? ".".PadRight(places + 1, '0') : "") + "E+0";
                ...
                if (value.Exponent >= 3 && value.Exponent < 6)
                {
                    return mantissa + "K";
                }
                if (value.Exponent >= 6 && value.Exponent < 9)
                {
                    return mantissa + "M";
                }
                if (value.Exponent >= 9 && value.Exponent < 12)
                {
                    return mantissa + "B";
                }
                if (value.Exponent >= 12 && value.Exponent < 15)
                {
                    return mantissa + "T";
                }
                if (value.Exponent >= 15 && value.Exponent < 18)
                {
                    return mantissa + "A";
                }
                if (value.Exponent >= 18 && value.Exponent < 21)
                {
                    return mantissa + "Aa";
                }
                if (value.Exponent >= 21 && value.Exponent < 24)
                {
                    return mantissa + "Ab";
                }
                if (value.Exponent >= 24 && value.Exponent < 27)
                {
                    return mantissa + "Ac";
                }
                if (value.Exponent >= 27 && value.Exponent < 30)
                {
                    return mantissa + "Ad";
                }
                if (value.Exponent >= 30 && value.Exponent < 33)
                {
                    return mantissa + "Ae";
                }
                if (value.Exponent >= 33 && value.Exponent < 36)
                {
                    return mantissa + "Af";
                }
                if (value.Exponent >= 36 && value.Exponent < 39)
                {
                    return mantissa + "Ag";
                }
                if (value.Exponent >= 39 && value.Exponent < 42)
                {
                    return mantissa + "Ah";
                }
                if (value.Exponent >= 42 && value.Exponent < 45)
                {
                    return mantissa + "Ai";
                }
                return mantissa + "E" + (value.Exponent >= 0 ? "+" : "")
            ...
            private static string FormatFixed(BigDouble value, int places)
            {
                ...
                //Два кейса:
                 // 1) показатель степени равен 17 или больше: просто распечатайте мантиссу с соответствующим количеством нулей после нее
                 // 2) показатель степени равен 16 или меньше: используйте базовый toFixed
